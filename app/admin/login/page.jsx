...
export default function AdminLogin() {
  ...
  async function onSubmit(e) {
    ...
    // With redirect:true, NextAuth navigates away on success.
    // If it returns here with an error, show it.
  ...
  return (
    <div className="h-full flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <form className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4" onSubmit={onSubmit}>
          <div>
            ...
            <input
              ...
              placeholder="admin@growthsense.com"
              autoComplete="email"
            />
          </div>
