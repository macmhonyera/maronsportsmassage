...
export const metadata = {
  ...
  description:
    "Book sports massage sessions online. Recovery-focused treatments by certified therapists.",
};
...
export default async function HomePage() {
  ...
  const features = [
    {
      ...
      description:
        "Qualified practitioners focused on athletic recovery, mobility, and injury prevention.",
    },
    {
      title: "Sport-Specific Care",
      description:
        "Treatment plans tailored to your training load and competition schedule.",
    },
    {
      title: "Easy Online Booking",
      description:
        "Pick a slot, confirm instantly, and get reminders before your session.",
    },
    {
      title: "WhatsApp Support",
      description:
        "Fast communication for rescheduling, questions, and appointment updates.",
    },
  ];
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h1 className="mt-6 text-4xl font-semibold tracking-tight text-white sm:text-5xl md:text-6xl">
                Modern sports massage for{" "}
                <span className="text-[#5EEAD4]">faster recovery</span> and{" "}
                <span className="text-white">better performance</span>.
              </h1>

              <p className="mt-5 max-w-2xl text-base text-slate-200 sm:text-lg">
                Maron delivers targeted treatment for athletes and active
                individuals. Reduce soreness, improve mobility, and stay ready
        ...
        <section className="bg-slate-50 py-14 md:py-20">
          <div className="mx-auto max-w-[1600px] px-4">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-3 text-base text-slate-600 md:text-lg">
                Choose the right treatment for your goals and schedule.
              </p>
            </div>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <Section
            ...
            subtitle="Real feedback from athletes and active individuals"
          >
            <Reviews />
          </Section>
        </div>
  ...
  <div className="absolute inset-0">
    ...
    {/* Very subtle depth layer (NOT opacity on image) */}
  ...
  <div className="relative z-10 mx-auto max-w-7xl px-4">
    <div className="mx-auto max-w-4xl rounded-3xl border border-white/30 bg-white/80 p-6 shadow-xl backdrop-blur-lg md:p-10">
      <Section
        title="Visit Us"
        subtitle="Conveniently located with easy access and parking"
      >
