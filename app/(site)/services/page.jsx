...
const SERVICES = [
  ...
  },
  {
    ...
    styles: [
      { name: "Structural", description: "Firm, deep pressure to release chronic tension." },
      { name: "Restorative", description: "Long, soothing strokes to relax and ease tension." },
    ],
  },
  {
    id: "stretch",
...
export default function ServicesPage() {
  return (
    <div className="space-y-0">
      {/* HERO */}
      <section className="relative overflow-hidden bg-[#0A1825] mt-5">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0A1825]/60 via-[#0A1825]/90 to-[#0A1825]" />
          <div
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  <div className="flex items-start justify-between gap-4">
                    <h3 className="text-lg font-semibold tracking-tight text-[#0F1F2E] sm:text-xl">
                      {s.name}
                    </h3>
                    <div className="text-right shrink-0">
                      ...
                      <div className="mt-0.5 text-xl font-bold text-[#0F1F2E] sm:text-2xl">
                      ...
                      <div className="mt-2 space-y-2">
                        {s.styles.map((st) => (
                          <div key={st.name} className="text-sm leading-relaxed">
                            <span className="font-semibold text-[#0F1F2E]">{st.name}</span>
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2">
            {ADD_ONS.map((a) => (
              ...
              >
                ...
                <h3 className="relative mt-4 text-lg font-semibold tracking-tight text-[#0F1F2E] sm:text-xl">
                  {a.name}
                </h3>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-10">
            ...
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              <div>
                <h3 className="text-2xl font-semibold text-[#0F1F2E] md:text-3xl">
